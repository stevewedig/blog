 ...
 */
public class TestGuavaValueObjects {
  ...
  public void testGuavaOptional() {
    ...
    TestHelpers.assertSameValueAndSameString(bob1, bob2);
    TestHelpers.assertDifferentValueAndDifferentString(bob1, alice);
    TestHelpers.assertDifferentValueAndDifferentString(bob1, absent1);
  ...
  public void testGuavaImmutableMap() {
    ...
    TestHelpers.assertSameValueAndSameString(bob1, bob2);
    TestHelpers.assertDifferentValueAndDifferentString(bob1, differentKey);
    TestHelpers.assertDifferentValueAndDifferentString(bob1, differentValue);
  }
