...
public abstract class ArrayUtils {
   ...
   * should be used as <code>ArrayUtils.clone(new int[] {2})</code>.
   * </p>
   * 
   * <p>
...
//  }
   ...
   *             {@code java.util.Objects.deepEquals(Object, Object)} and will be removed from
   *             future releases.
   */
//  @Deprecated
...
//  }
  ...
  /**
   * <p>
   * Converts the given array into a {@link java.util.Map}. Each element of the array must be either
   * a {@link java.util.Map.Entry} or an Array, containing at least two elements, where the first
   ...
   * 
   * <p>
   * Therefore new arrays of generic types can be created with this method. For example, an array of
   ...
   * 
   * <p>
   * The method is typically used in scenarios, where the caller itself uses generic types that have
   * to be combined into an array.
   * </p>
   * 
   * <p>
...
//  }
   ...
   */
  public static double[] subarray(final double[] array, int startIndexInclusive,
   ...
   */
  public static boolean[] subarray(final boolean[] array, int startIndexInclusive,
      int endIndexExclusive) {
    if (array == null) {
      return null;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final boolean[] array, final int startIndexInclusive,
   ...
   * @since 3.2
   */
  public static void reverse(final byte[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final char[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final double[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final float[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final int[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final long[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final Object[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @since 3.2
   */
  public static void reverse(final short[] array, final int startIndexInclusive,
      final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   * @param objectToFind the object to find, may be {@code null}
   * @return the last index of the object within the array, {@link #INDEX_NOT_FOUND} ({@code -1}) if
   ...
   * @return the last index of the value within the array, {@link #INDEX_NOT_FOUND} ({@code -1}) if
   *         not found or {@code null} array input
   */
  ...
  /**
   * <p>
   * Finds the last index of the given value within a given tolerance in the array. This method will
   * return the index of the last value which falls between the region defined by valueToFind -
   * tolerance and valueToFind + tolerance.
   * </p>
   * 
   * <p>
   ...
   *         is the type of the first array, unless the first array is null, in which case the type
  ...
  public static <T> T[] addAll(final T[] array1, final T... array2) {
    ...
    try {
      ...
      /*
       * We do this here, rather than before the copy because: - it would be a wasted check most of
       * the time - safer, in case check turns out to be too strict
       */
   ...
   * element on the specified position. The component type of the returned array is always the same
   ...
   * @return A new array containing the existing elements and the new element
   */
  private static Object add(final Object array, final int index, final Object element,
      final Class<?> clss) {
    if (array == null) {
      if (index != 0) {
  ...
  /**
   * <p>
   * Removes the first occurrence of the specified element from the specified array. All subsequent
   * elements are shifted to the left (subtracts one from their indices). If the array doesn't
   * contains such an element, no elements are removed from the array.
   * </p>
   * 
   * <p>
   ...
   * specified positions. The component type of the returned array is always the same as that of the
   * input array.
   * </p>
   * 
   * <p>
   ...
   * earliest-encountered occurrences of the specified elements. The component type of the returned
...
//      return clone(array);
//    }
//    final HashMap<Integer, MutableInt> occurrences =
//        new HashMap<Integer, MutableInt>(values.length);
...
//      return clone(array);
//    }
//    final HashMap<Character, MutableInt> occurrences =
//        new HashMap<Character, MutableInt>(values.length);
